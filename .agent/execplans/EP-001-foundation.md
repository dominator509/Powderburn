...
## 11. Progress
- [x] M1 Workspace manifest and toolchain pin
- [x] M2 Crate skeletons with the import law encoded
- [x] M3 Vendor everything and go offline permanently
- [x] M4 One real passing test
- [x] M5 Prove the determinism lint fires
- [x] M6 Green verify on the skeleton

## 12. Surprises and Discoveries

- The gate scripts needed to remain meaningful as the skeleton grew; later hardening exposed and
  removed permissive placeholder behavior rather than preserving stage-only shortcuts.

## 13. Decision Log

- 2026-07-27: The default build stays permanently offline and all third-party crates remain
  vendored. Feature-gated development surfaces may not weaken the default release.

## 14. Outcomes and Retrospective

Completed. The twelve crates build from the vendor tree with the pinned toolchain; format, clippy,
import-law, determinism, dependency, and real unit-test gates are fail-closed. Smoke and live fire
became meaningful after content and command implementation and are proven by later nodes.
